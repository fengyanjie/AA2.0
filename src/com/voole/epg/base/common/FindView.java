...
import com.voole.epg.base.common.FindItemView.Status;
...
public class FindView extends BaseLinearLayout {
	...
	public void resetDisplay(){
		itemViews[currentSelectedIndex - startIndex]
				.setCurrentStatus(Status.Normal);
...
//		}
		...
		int labelLen=LabelNames.size();
		for(int i = 0, j = startIndex; i<ITEM_SIZE&&j<labelLen; i++, j++){
